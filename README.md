...
You can skip the first step and use one of our partners deployed airnodes on RSK {insert link to these} by modifying src/parameters.js, or you can call the CoinGecko example one we deployed on RSK without making any code changes.
